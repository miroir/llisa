...
def banner():
    llisa2 = """
     ...
     l::::l  l::::l i:::::i   ss::::::::::s    a::::::::::::a
     l::::l  l::::l  i::::i ss:::::::::::::s   aaaaaaaaa:::::a
     l::::l  l::::l  i::::i s::::::ssss:::::s           a::::a
     l::::l  l::::l  i::::i  s:::::s  ssssss     aaaaaaa:::::a
     l::::l  l::::l  i::::i    s::::::s        aa::::::::::::a
     l::::l  l::::l  i::::i       s::::::s    a::::aaaa::::::a
     l::::l  l::::l  i::::i ssssss   s:::::s a::::a    a:::::a
     l::::::ll::::::li::::::is:::::ssss::::::sa::::a    a:::::a
     l::::::ll::::::li::::::is::::::::::::::s a:::::aaaa::::::a
     l::::::ll::::::li::::::i s:::::::::::ss   a::::::::::aa:::a
     lllllllllllllllliiiiiiii  sssssssssss      aaaaaaaaaa  aaaa
        """
    print(tty_colors.green() + random.choice([llisa2]) + tty_colors.default())
    ...
    if lldb.target:
        ...
        for thread_idx in range(lldb.process.num_threads):
            ...
            for (frame_idx, frame) in enumerate(thread.frames):
                ...
                out_file.write(
                    '%-3u %-32s 0x%16.16x %s</br>' % (frame_idx, frame.module.file.basename, frame_pc, frame.name))
                if frame_offset > 0:
...
def exploitable(debugger, command, result, dict):
    ...
    if stopreason == lldb.eStopReasonException:
        ...
        if access_address == getregvalue(debugger, "pc", result, dict):
            ...
            print
            tty_colors.blue() + "Arithmetic exception at 0x%016qx, probably not exploitable." + tty_colors.default()
